...
static int write_buffer(int out, char *buffer, int block_size, int *remain_to_write)
{
...
static int copy_ndir_block(int img, int out, int block_size, int block_id, int *remain_to_write, char *buffer)
{
	read_block(img, block_size, block_id, buffer);
	write_buffer(out, buffer, block_size, remain_to_write);
	return 0;
}
static int copy_indir_block(int img, int out, int block_size, int block_id, int *remain_to_write, char *buffer)
{
	read_block(img, block_size, block_id, buffer);
...
static int copy_dndir_block(int img, int out, int block_size, int block_id, int *remain_to_write, char *buffer)
{
	read_block(img, block_size, block_id, buffer);
	int *buffer_addr_iter = (int *)buffer;
